...
# сделать логи и/или отлов ошибок HALF_COMPLETED
# добавление в корзину COMPLETED
# добавить поддержку картинок товаров TOMORROW
# !!!! обработка покупок (количество товара должно уменьшаться после покупки, чек равный id покупки) TOMORROW
# ! сохранение информации после рестарта страницы ( через куки) TO DO LATER
# отзывы сделать
# ? скидки если будет время
# убедиться что sql файлы создают всё правильно
# !!! разобраться нужно ли пересоздавать sales_history TOMORROW
# удаление товаров админом !!  каскадом? TODAY
# сделать корзину TOMORROW
# Нужно ли оформлять по особому?
# Насчёт слов Вани о том, можно ли sql тут запускать
# панель админа ( страница) со статистикой продаж HALF_TOMORROW
# 
